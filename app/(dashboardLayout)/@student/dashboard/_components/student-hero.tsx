        ...
        <div className="mt-8 flex flex-col sm:flex-row items-start sm:items-center gap-4 relative z-10">
          {isPast ? (
            ...
            <div className="flex flex-col gap-1">
              <Button
                disabled
                className="bg-slate-800 text-slate-500 cursor-not-allowed border border-slate-700 px-8 h-12 rounded-2xl"
              >
                Class Finished
              </Button>
      ...
      <div className="space-y-4 text-center">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">
            Explore over 500+ expert tutors.
          </p>
        </div>
        <Button
          asChild
          className="w-full bg-rose-600 hover:bg-rose-700 dark:bg-rose-600 dark:hover:bg-rose-700 text-white font-bold rounded-xl"
        >
...
function EmptyHeroState() {
  return (
    <div className="md:col-span-2 bg-slate-50 dark:bg-slate-900/50 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-3xl p-8 flex flex-col items-center justify-center text-center h-[280px]">
      ...
      <Button
        asChild
        className="bg-slate-900 dark:bg-rose-600 dark:hover:bg-rose-700 text-white font-bold rounded-xl px-8"
      >
